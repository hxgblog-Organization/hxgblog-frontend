<template>
    <div class="show-exhibit">
        <div class="headers">
            ...
            <el-button class="add-exhibit" type="primary" @click="diaAddMusicVisible = true">上传音乐<i class="el-icon-upload el-icon--right"></i></el-button>
            <el-button type="primary" ><i class="el-icon-plus el-icon--left" @click="showEditExhibitDiag">添加名言</i></el-button>
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <el-button
                            type="text"
                            size="small">
                        <el-button type="primary" v-if="exhibitDist !== '4'" icon="el-icon-edit"   size="mini" @click="showUpdateDiag(scope.$index)">编辑</el-button>
                        <el-button type="info" v-if="exhibitDist !== '4'" icon="el-icon-view"   size="mini" @click="showDetails(scope.$index)">查看详情</el-button>
                        <el-button type="danger"  icon="el-icon-delete" size="mini" @click="beforedeleteExhibit(exhibitData[scope.$index].exht_id)">删除</el-button>
                        <el-button v-if="exhibitData[scope.$index].exht_status !== 1 " type="warning" icon="el-icon-edit"   size="mini" @click="replaceExhibitData(exhibitData[scope.$index].exht_id)">替换</el-button>
                        <el-button v-if="exhibitDist === '4'" type="success" icon="el-icon-download"   size="mini" @click="downloadExhibit(exhibitData[scope.$index].exht_name)">下载</el-button>
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
                ...
                <el-form-item label="名字" :label-width="formLabelWidth" :required="true">
                    ...
                    <div v-if="exhibitDist === '1'">
                        <el-form-item label="First" :label-width="formLabelWidth" :required="true">
                            <el-input type="textarea" v-model="homeExhibitForm.first" maxlength="20px" auto-complete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="Second" :label-width="formLabelWidth" :required="true">
                            <el-input type="textarea" v-model="homeExhibitForm.second" maxlength="20px" auto-complete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="Third" :label-width="formLabelWidth" :required="true">
                            <el-input type="textarea" v-model="homeExhibitForm.third" maxlength="20px" auto-complete="off"></el-input>
                        </el-form-item>
                    </div>
        ...
        methods: {
            ...
            showEditExhibitDiag() {
                ...
                switch (this.exhibitDist) {
                    case '1': this.editExhibitTitle = "添加首页名言";break;
                    case '2': this.editExhibitTitle = "添加文章名言";break;
                    case '3': this.editExhibitTitle = "添加留言名言";break;
                }
            ...
            showUpdateDiag(index) {
                ...
                switch (this.exhibitDist) {
                    case '1': self.editExhibitTitle = "修改首页名言";break;
                    case '2': self.editExhibitTitle = "修改文章名言";break;
                    case '3': self.editExhibitTitle = "修改留言名言";break;
                }
            ...
            showDetails(index) {
                ...
                let self = this;
                switch (this.exhibitDist) {
                    case '1': self.showDetailTitle = "首页名言详情";break;
                    case '2': self.showDetailTitle = "文章名言详情";break;
                    case '3': self.showDetailTitle = "留言名言详情";break;
                }
                self.exhibitName        = self.exhibitData[index].exht_name;
                self.exhibitId          = self.exhibitData[index].exht_id;
