            ...
            <aside class="right">
                <div class="today-weather">
                    ...
                    <div class="wleft">
                        <div class="wtname">
                            ...
                            <a v-bind:href="weatherUrl" target="_blank" style="line-height:18px; font-family:'微软雅黑'">{{
                                cityName }}</a>
                        </div>
                        <div class="order-one">
                ...
                <div class="news">
                    ...
                    <ul class="website">
                        ...
                        <li><a target="_blank" href="https://www.cnblogs.com/l199616j">海贼王简书地址</a></li>
                        <li><a target="_blank" href="https://github.com/l199616j0">海贼王GitHub code</a></li>
                    </ul>
                </div>
...
<style scoped>
    ...
    .avatar a {
        ...
        padding-top: 97px;
        width: 160px;
        background: url(../../images/reception/me.jpg) no-repeat;
    ...
    h2.title_tj {
        font: 18px "Î¢ÈíÑÅºÚ", Arial, Helvetica, sans-serif;
        color: #444;
        font-weight: bold;
        background: url(../../images/reception/h_line.jpg) repeat-x 20px center;
    }
    ...
    .bloglist {
        width: 740px;
        overflow: hidden;
        background: url(../../images/reception/r_line.jpg) repeat-y right;
    }
    ...
    .dateview {
        ...
        background: #f6f6f6 url(../../images/reception/time.jpg) 15px center no-repeat;
        line-height: 26px;
        height: 26px;
        color: #838383;
        padding-left: 25px
    ...
    .today-weather {
        background: url(../../images/reception/weather_bg.jpg) no-repeat;
        height: 88px;
        padding: 0 0 0 55px;
    }
    ...
    .news h3 {
        font-size: 14px;
        background: url(../../images/reception/r_title_bg.jpg) repeat-x center
    }
    ...
    .wei-xin {
        background: url(../../images/reception/hxg-gzh.jpg) no-repeat;
        width: 100%;
        display: inline-block;
        height: 274px;
        overflow: hidden;
