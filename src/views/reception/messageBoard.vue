        ...
        <article>
            <div class="container">
                ...
                <div class="gbook">
                    ...
                    <div id="leave-div">
                        <textarea v-model="leaveMessage" class='form-control' placeholder='请你留下你的足迹......'
                                  rows='3'></textarea>
                        <button type='button' @click="sendMessage" class='btn btn-primary btn-xs leave-btn'>发表留言
                        </button>
                    </div>
                </div>
            </div>
                                                ...
                                                <div class="gbko">
                                                    <div>
                                                        ...
                                                        <span class="dl-replay-btn">
                                                            <a v-if="data.is_mine"
                                                               @click="showMessageTextarea($event, data.msg_id, msg.msg_id, childIndex, fatherIndex)">回复</a>
                                                            <a v-if="msg.is_admin"
                                                               @click="deleteLeaveMessage(data.msg_id)">删除</a>
                                                        </span>
                                                    </div>
                                                </div>
                                            </li>
...
<style scoped>
    ...
    .leave-message-li .cbp_tmtime span {
        display: block;
        text-align: right;
    }

    .leave-message-li .cbp_tmtime span:first-child {
        font-size: 14px;
        color: #bdd0db;
    }

    .leave-message-li .cbp_tmtime span:last-child {
        font-size: 22px;
        color: #3594cb;
    }

    .leave-message-li .cbp_tmlabel {
    ...
    .leave-message-li .cbp_tmlabel h2 {
        margin-top: 0px;
        padding: 0 0 10px 0;
        font-size: 16px;
    ...
    .leave-message-li .cbp_tmlabel:after {
        right: 100%;
    ...
    .leave-message-li:hover .cbp_tmicon {
        box-shadow: 0 0 0 3px #ececec;
    }

    .leave-message-li:hover .cbp_tmtime {
        background: lemonchiffon;
        border-radius: 20px 0 0 20px;
    }

    .leave-message-li:hover .cbp_tmtime span {
        color: #075498;
    }
</style>
