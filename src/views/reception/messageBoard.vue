...
<style scoped>
    ...
    .cbp_tmtimeline > li .cbp_tmlabel { margin: 0 50px 15px 180px;color: #000; padding: 2em; position: relative; border-radius: 5px; height: 150px; }
    ...
    .cbp_tmtimeline li:hover .cbp_tmtime { background: lemonchiffon; border-radius: 20px 0 0 20px; }
