        ...
        <article class="main-article">
            ...
            <div class="infosbox">
                ...
                <div class="news_pl">
                    ...
                    <div>
                        <div id="publish-div">
                            <textarea v-model="publishContent" class='form-control' placeholder='请你留下你的足迹......'
                                      rows='3'></textarea>
                            <button type='button' @click="publishComment" class='btn btn-primary btn-xs publish-btn'>
                                发表评论
                            </button>
                        </div>
...
<style scoped>
    ...
    .tuijian li {
        ...
        overflow: hidden;
        margin-bottom: 5px;
        background: url(../../images/reception/li.png) left center no-repeat;
        padding-left: 20px
    }
